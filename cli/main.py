...
def main() -> None:
    if len(sys.argv) < 2:
        ...
        print('  ai-hub stats                 Show execution statistics (V0.9.7)')
        print('  ai-hub stats --plan <id>     Statistics for a specific plan')
        print('  ai-hub stats --provider <name>  Statistics for a specific provider')
